...
# 参考 https://zhuanlan.zhihu.com/p/52054982?from_voters_page=true
def save_dataset(args):
    ...
    for p_ind, patient in enumerate(patients_list):
        print("processing:", p_ind, patient)
        ...
        printProgressBar(p_ind+1, len(patients_list),
                         prefix="save image ..",
...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_path', type=str, default='F:/sgzb数据集/AAPM-Mayo-CT-Challenge/3mm B30')
    parser.add_argument('--save_path', type=str, default='./npy_img2/')
